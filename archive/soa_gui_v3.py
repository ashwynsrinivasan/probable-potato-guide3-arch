...
class Guide3GUI(tk.Tk):
    def __init__(self):
        ...
        # --- Common Inputs ---
        common_frame = ttk.LabelFrame(scrollable_frame, text="Common Parameters", padding="10")
        ...
        ttk.Label(common_frame, text="Width (µm) [2.0-2.7]:").pack(pady=(5, 2), anchor='w')
        self.w_um_var = tk.StringVar()
        self.w_um_entry = ttk.Entry(common_frame, textvariable=self.w_um_var, width=15)
        ...
        nominal_frame = ttk.LabelFrame(scrollable_frame, text="Nominal Conditions", padding="10")
        nominal_frame.pack(fill=tk.X, pady=5)
        ...
        # --- FIX: Use .grid() for the button and save a reference to it ---
        self.calc_button = ttk.Button(self.output_frame, text="Calculate Outputs", command=self.update_output_display)
        self.calc_button.grid(row=0, column=0, columnspan=2, pady=5)
    ...
    def update_output_display(self):
        ...
        # --- FIX: Clear previous results, but keep the button that triggers this function ---
